...
tame = Artist.create(name: "Tame Impala", band_members: 4, band_img: "https://beat.com.au/wp-content/uploads/2018/07/tames.jpg")
gorillaz = Artist.create(name: "Gorillaz", band_members: 4, band_img: "https://www.nme.com/wp-content/uploads/2021/09/gorillaz-2021@2000x1270-1.jpg")
phoenix = Artist.create(name: "Phoenix", band_members: 4, band_img: "http://pilerats.com/assets/Uploads/phoenix-new-album-2020.jpg")
pink_floyd = Artist.create(name: "Pink Floyd", band_members: 4, band_img: "https://i.scdn.co/image/d011c95081cd9a329e506abd7ded47535d524a07")
goth_babe = Artist.create(name: "Goth Babe", band_members: 1, band_img: "https://images.squarespace-cdn.com/content/v1/586d703af7e0ab58e693a869/1542598230762-RC3OK5OZWIB6WWYXGYS2/image2.jpeg?format=1000w")
arcade_fire = Artist.create(name: "Arcade Fire", band_members: 6, band_img: "https://i.guim.co.uk/img/media/da207ed976e1b316bab8a8ae547b6dbdc992911f/504_0_4674_2805/master/4674.jpg?width=1200&height=900&quality=85&auto=format&fit=crop&s=0f625bcdff3a9aede290d4cfa832dcfa")
moby = Artist.create(name: "Moby", band_members: 1, band_img: "https://moby.com/wp-content/uploads/2021/05/moby-doc-full-bg-copy-500x500.jpeg")
tycho = Artist.create(name: "Tycho", band_members: 1, band_img: "https://images.squarespace-cdn.com/content/v1/5cb099837046801bf8ed1e65/1580310259680-LJFFNTI3X0H48U1DDBL8/Tycho+-+Press+LA2020-Small.jpg?format=2500w")
rem = Artist.create(name: "R.E.M", band_members: 4, band_img: "https://www.billboard.com/wp-content/uploads/media/rem-1990-billboard-650.jpg")
